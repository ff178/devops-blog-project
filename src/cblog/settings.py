...
DATABASES = {
    'default': {
        ...
        'NAME': 'blogproject', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': 'Cali12345$',
        'HOST': 'blogproject.ct4yuq8ka7ut.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blog-project-tech' # please enter your s3 bucket name
